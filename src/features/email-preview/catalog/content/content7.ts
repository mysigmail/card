...
function buildContent7Block(label: string): BlockNode {
...
export function content7Preset(_: ComponentTheme, label: string): BlockPreset {
  return {
    id: nanoid(8),
    version: 2,
    name: 'content7',
    ...
    block: buildContent7Block(label),
  }
}
