...
function buildContent8Block(label: string): BlockNode {
...
export function content8Preset(_: ComponentTheme, label: string): BlockPreset {
  return {
    id: nanoid(8),
    version: 2,
    name: 'content8',
    ...
    block: buildContent8Block(label),
  }
}
