...
const content7Composition = composeEmailBlock({
  groups: {
    layout: {
      role: 'layout',
      id: 'Layout',
...
export const content7: ComponentBuilder = (_, label) => {
  return {
    id: nanoid(8),
    name: 'Content7',
    label,
    schema: content7Composition.schema,
    type: 'content',
    preview: images.components.content7,
    tools: content7Composition.createTools(),
  }
}
