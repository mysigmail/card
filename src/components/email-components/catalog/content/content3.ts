...
const content3Composition = composeEmailBlock({
  groups: {
    layout: {
      role: 'layout',
      id: 'Layout',
...
export const content3: ComponentBuilder = (_, label) => {
  return {
    id: nanoid(8),
    name: 'Content3',
    label,
    schema: content3Composition.schema,
    type: 'content',
    preview: images.components.content3,
    tools: content3Composition.createTools(),
  }
}
