...
function buildContent8ComposerBlock(label: string): Block {
...
export function content8Composer(_: ComponentTheme, label: string): BlockCatalogComponent {
  return {
    id: nanoid(8),
    version: 2,
    name: 'content8-composer',
    label,
    type: 'content',
    preview: images.components.content8,
    block: buildContent8ComposerBlock(label),
  }
}
