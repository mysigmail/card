...
import type { ColorPickerTool, ComponentBuilder, ImageTool, InputNumberTool, InputTool, MultiTool, PaddingTool, PaddingToolValue, SingleTool, Tool, ToolType, ToolTypeMap, ToolValue } from '@/types/editor'
